    ...
    <div style={styles.container} className="w-full p-4 md:p-8">
      <div style={styles.card} className="p-3 md:p-7 lg:p-9">
        ...
        >
          ...
          These rights may include accessing the data we hold about you,
          requesting corrections or deletions, limiting how we process your
          data, and withdrawing your consent where applicable.
        </p>
      </div>
    </div>
  );
