  ...
  return (
    <div style={styles.container} className="w-full p-4 md:p-8">
      <div style={styles.card} className="p-3 md:p-7 lg:p-9">
        ...
        >
          At CherryFlight, we value your privacy and are committed to protecting
          ...
          you use our website
          ([www.cherryflight.com](http://www.cherryflight.com)) and services
          related to air travel, car rentals, activities, and cruise bookings.
        </p>
        <p
          style={styles.paragraph}
          className="text-justify text-sm md:text-base font-gotham font-light"
