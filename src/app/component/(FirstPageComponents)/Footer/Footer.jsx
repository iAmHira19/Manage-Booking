...
const Footer = ({ showPaymentImages }) => {
  const pathname = usePathname();
  return (
    <footer className="w-full bg-white font-gotham flex flex-col gap-y-4 lg:gap-y-6">
      {/* Payment Methods */}
      <div
        className={`w-full justify-center items-center gap-x-7 ${
          showPaymentImages ? "flex" : "hidden"
        }`}
      >
        <Image
          unoptimized
          width={90}
          height={90}
          src="/img/Certifications/iata-logo.png"
          alt="Certifications"
        ...
        <Image
          ...
          width={90}
          height={90}
          src="/img/Certifications/ndc-logo-big.png"
          alt="Certifications"
        ...
        <Image
          ...
          width={90}
          height={90}
          src="/img/Certifications/travelport.jpeg"
          alt="Certifications"
          className="w-16 md:w-18"
        ></Image>
      </div>
      <div
        className={`${
          showPaymentImages ? " flex" : "hidden"
        } flex-wrap justify-center items-center text-center gap-x-5 lg:gap-10 px-4 sm:px-8`}
      >
        {/* {[
          // "/img/p1.jpeg",
          "/img/p2.jpeg",
          ...
          <Image
            ...
            width={48}
            height={32}
            className="w-12 h-8 sm:w-18 sm:h-12 md:w-20 md:h-14"
            alt={`Payment-${index}`}
          />
        ))} */}
        <svg
      ...
      <nav className="w-full mt-4">
        <ul className="flex flex-wrap justify-center text-center gap-x-5 gap-y-3 sm:gap-8 md:gap-10 text-xs sm:text-sm px-2">
          <li
            className={`${
              pathname == "/" ? "text-orange-500" : "text-blue-900"
            }`}
          >
            <Link
              href="/"
          ...
          <li
            className={`${
              pathname == "/about_us" ? "text-orange-500" : "text-blue-900"
            }`}
          >
            <Link
              href="/about_us"
          ...
          <li
            className={`${
              pathname == "/contact_us" ? "text-orange-500" : "text-blue-900"
            }`}
          >
            <Link
              href="/contact_us"
          ...
          <li
            className={`${
              pathname == "/FAQ" ? "text-orange-500" : "text-blue-900"
            }`}
          >
            <Link
              href="/FAQ"
          ...
          <li
            className={`${
              pathname == "/T&C" ? "text-orange-500" : "text-blue-900"
            }`}
          >
            <Link
              href="/T&C"
          ...
          <li
            className={`${
              pathname == "/refund_policy" ? "text-orange-500" : "text-blue-900"
            }`}
          >
            <Link
              href="/refund_policy"
      ...
      <div className="flex flex-col items-center py-3 w-full">
        <p className="text-slate-500 text-xs sm:text-base font-gotham text-center md:text-start px-2 md:px-0">
          Copyright {new Date().getFullYear()} Cherry Flight Private Limited.
          All rights reserved.
        </p>
        <div className="flex gap-2 md:gap-5 py-3 sm:py-1 md:py-4 text-md md:text-lg">
          <Link
          ...
          <Link href="https://x.com" target="_blank" className="text-black">
            <FaXTwitter />
          </Link>
        </div>
      </div>
